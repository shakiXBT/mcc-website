...
### My first bet for 2022 is TempleDAO (TEMPLE). 

Temple has suffered greatly from a few consecutive bad choices by the dev team (mainly regarding the exit queue mechanism). This has caused a nasty downtrend that brought the coin close to its IV of $0.65 FRAX per temple token, while making the most speculative side of the community sell and walk away. 

While it's clear that the dev team made mistakes, they look talented enough to be able to pivot the focus of the project and adjust what's wrong with it. It is certainly not going to be an easy task, but we've seen this happen before.

In 2022 it will be clear if the remains of the TEMPLE community have what it takes to meme and develop as a next level crypto project like OHM. The familiarities are there, especially thanks to a talented dev team and artistically gifted community.

### My second bet for 2022 is Alchemist (MIST). 
